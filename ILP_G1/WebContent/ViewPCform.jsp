...
<form name="searchpc" action="searchPC" method="post"
...
<table>
	...
	<tr>
		<td>Contact No:</td>
		<td><input type="text" name="con" maxlength="10"></input></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
<br />
<br />
<p>Click "<i><b>Search</b></i>" Button without inputs to see the
full list.</p>
</form>
