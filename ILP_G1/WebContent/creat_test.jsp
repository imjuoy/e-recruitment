				...
				<div class="sidebar">
					<div class="article">
						...
						<div class="post_content">
							<form method="post" action="CreateTestSchedule">
								<table>
									<tr>
										<td colspan=2></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" name="taid" value="" /></td>
									</tr>
									<tr>
										<td><b>Vacancy ID</b></td>
										<td><input type="text" name="vacid" value="" /></td>
									</tr>
									<tr>
										<td><b>WrittenTest Date (DD-MMM-YYYY)</b></td>
										<td><input type="text" name="wtdate" value="" /></td>

									</tr>
									<tr>
										<td><b>Technical Interview Date(DD-MMM-YYYY)</b></td>
										<td><input type="text" name="tidate" value="" /></td>
									</tr>
									<tr>
										<td><b>HR Interview Date (DD-MMM-YYYY)</b></td>
										<td><input type="text" name="hrdate" value="" /></td>
									</tr>

									<tr>
										<td><input type="reset" name="reset" value="Reset Form" /></td>
										<td><input type="submit" name="submit"
											value="Schedule Test" /></td>
									</tr>
									<tr>
										<td colspan=2></td>
									</tr>
