...
<form method="post" action="DisplayEditDeleteCandStatus">
<table>
	<tr>
		<td colspan=2></td>
	</tr>
	...
	if(rs.getInt(4)==1 && rs.getInt(5)==0){
		out.println("<tr>");
		out.println("<td><b>HR Interview Status</b></td>");
		out.println("<td><select name='hristatus'>");
		out.println("<option value='0'>Pending</option>");
		out.println("<option value='1'>Passed</option>");
		out.println("<option value='2'>Failed</option>");
		out.println("</select></td>");
		...
		out.println("<tr>");
		out.println("<td><input type='hidden' value='"+rs.getInt(5)+"' name='hristatus' />");
		out.println("<b>HR Interview Status : Passed<b>");
		out.println("</td>");
		out.println("</tr>");
	}
	else if(rs.getInt(4)==0 && rs.getInt(5)==0){
		out.println("<tr>");
		out.println("<td><input type='hidden' value='"+rs.getInt(5)+"' name='hristatus' />");
		out.println("</td>");
		out.println("</tr>");
	...
	%>
	<% 
	if(rs.getInt(5)==1 && rs.getInt(6)==0){
		out.println("<tr>");
		out.println("<td><b>Medical Status</b></td>");
		out.println("<td><select name='medicalstatus'>");
		out.println("<option value='0'>Pending</option>");
		out.println("<option value='1'>Passed</option>");
		out.println("<option value='2'>Failed</option>");
		out.println("</select></td>");
		...
		out.println("<tr>");
		out.println("<td><input type='hidden' value='"+rs.getInt(6)+"' name='medicalstatus' />");
		out.println("<b>Medical Status : Passed<b>");
		out.println("</td>");
		out.println("</tr>");
	}
	else if(rs.getInt(5)==0 && rs.getInt(6)==0){
		out.println("<tr>");
		out.println("<td><input type='hidden' value='"+rs.getInt(6)+"' name='medicalstatus' />");
		out.println("</td>");
		out.println("</tr>");
...
<ul class="sb_menu">
	<jsp:include page="hr_side_menu.jsp"></jsp:include>
</ul>
</div>
