...
<script type="text/javascript"
	src="js/jquery.searchabledropdown-1.0.8.min.js"></script>
<script type="text/javascript">
...
<div class="sidebar">
<div class="article">
<h2><span>HR Recruitment Officer Home</span></h2>
<ul class="sb_menu"></ul>
<br />
<br />
...
<form action="DisplayCandidateProfile" method="post">
<table>
	<tr>
		<td><select name="vacancyId" id="vacancyId">
			<%
				while (rs2.next()) {
		...
		<td><input type="submit" value="Show Candidates" /></td>
	</tr>
</table>
</form>
</div>
...
<ul class="sb_menu">
	...
	<li><a href="RecruitmentRequest">View Recruitment Request</a></li>
