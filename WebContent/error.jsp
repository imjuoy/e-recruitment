...
<h3 align="center">There was an internal error...<br />
<br />
<br />
Please try again later or contact developer...</h3>
...
<ul class="sb_menu">
	<%
		if((session.getAttribute("desg").toString()).equals("hr"))
		{ %>
	...
	<%
		if((session.getAttribute("desg").toString()).equals("basic"))
		{ %>
	...
	<%
		if((session.getAttribute("desg").toString()).equals("uh"))
		{ %>
	<%@ include file="basic_menu.jsp"%>
	<%	}
