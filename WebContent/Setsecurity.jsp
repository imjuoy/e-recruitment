...
<form name="addpc" action="setquestion" method="post">
<table>


<tr>
	<td>Select your Security Question<sup style='color:red; font size:12px'>*</sup></td>
	<td>
		<select name="ques">
...
<tr>
<td>Answer <sup style='color:red; font size:12px'>*</sup></td>
...
<tr>
	<td></td>	<td colspan="2"> <input type="submit" name="rst_pwd" value="set question"></td>
	</tr>
